...
class graffiti_bb_CreateBlogPost(graffitiTestCase):
    ...
    def test(self):
        ...
        try:
            ...
            sel.wait_for_page_to_load("30000")
            sel.type("//*[@id=\"ctl00_MainRegion_txtTitle\"]", "Cras tristique, enim ac ornare facilisis, ante justo euismod urna; ac varius nisl libero sed velit? Pellentesque tempus mollis pharetra. Etiam blandit risus augue, eget venenatis elit. Curabitur et lorem nec enim ultricies viverra. Curabitur ligula nullam.")
            ...
            sel.wait_for_page_to_load("30000")
            self.failUnless(sel.is_text_present("exact:Cras tristique, enim ac ornare facilisis, ante justo euismod urna; ac varius nisl libero sed velit? Pellentesque tempus mollis pharetra. Etiam blandit risus augue, eget venenatis elit. Curabitur et lorem nec enim ultricies viverra. Curabitur ligula nullam"))
